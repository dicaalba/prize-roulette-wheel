...
echo "    En producción (GitHub Pages) el frontend usa HTTP polling cada 15s."
echo "    En localhost el admin y el display se sincronizan por WebSocket real (sin polling)."
