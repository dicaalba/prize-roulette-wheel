/**
 * Prize Roulette Wheel - Request Handler Module
 * Extracted for reuse between standalone server and Lambda handler
 */
const fs = require('fs');
...
module.exports = { handleRequest, serveStaticFile, MIME_TYPES };
